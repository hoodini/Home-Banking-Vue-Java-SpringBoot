...
public class OperationsServiceLoansTest {
    ...
    void testLoanRejectionMissingFields() {
        ...
        ResponseEntity<?> response3 = operationsService.postLoans(authentication, invalidDTO3);
        ...
        assertEquals("Please fill in all the fields of the form", response3.getBody());
        verify(clientLoanRepository, never()).save(any(ClientLoan.class));
    }
